...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference("Discussion.count") do
      post discussions_url, params: { discussion: { author: @discussion.author, book: @discussion.book, creator_id: @discussion.creator_id, description: @discussion.description } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { author: @discussion.author, book: @discussion.book, creator_id: @discussion.creator_id, description: @discussion.description } }
